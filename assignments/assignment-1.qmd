...
# Compute the median, ignoring NA values
...
# Replace NA values with random values from the dataset
...
stats_df <- data.frame(
  ...
  Mean = c(mean(na_example, na.rm = TRUE),
           mean(version1, na.rm = TRUE),
           mean(version2, na.rm = TRUE)),
  Standard_Deviation = c(sd(na_example, na.rm = TRUE),
